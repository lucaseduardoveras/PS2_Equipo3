...
# Extraer predicciones internas de la CV
pred_cv <- model1$pred %>%
...
# Identificar observaciones con NA en test
...
write.csv(predictSample,"stores/modelos/naive_bayes_p_0_14.csv", row.names = FALSE)