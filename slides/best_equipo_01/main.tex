...
\footnotesize\textit{Clave:} el ajuste del umbral $\tau^{*}$ fue determinante en todos los modelos; los Random Forest superan al resto al combinar baja varianza y alta capacidad de discriminación.
\end{frame}
